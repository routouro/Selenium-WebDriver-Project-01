...
@Deprecated
public class NewHomepageV2 extends BaseTest {
    ...
    @Test
    public void testFirstNewHomepageV2 () {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.HOME_NEW_URL);

        Actions.homeNewActions().performShowMeFreeTrialActivity();

        Pages.homeNewPage().waitLinkShowMeFreeTrialDisappear();
    ...
    @Test
    public void testSecondNewHomepageV2 () {
        orderData = orderData.generateOrderData();
