...
public class Sprayablesleep1 extends BaseTest {
    ...
    @Test
    public void testSprayablesleep1 () {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.SPRAYABLE_SLEEP_URL);

        Pages.sprayablesleepPage().clickLinkTrySprayableSleep();

        Pages.sprayablesleepPage().waitLinkTrySprayableSleepDisappear();
