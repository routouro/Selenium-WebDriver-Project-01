...
public class OldStyle8V2 extends BaseTest {
    ...
    @Test
    public void testFirstOldStyle8V2 () {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.NO_MORE_JET_LAG_URL);

        Actions.noMoreJetLagActions().performShowMeFreeTrialActivity();

        Pages.noMoreJetLagPage().waitLinkShowMeFreeTrialDisappear();
    ...
    @Test
    public void testSecondOldStyle8V2 () {
        orderData = orderData.generateOrderData();
