...
public class SimpleOrderV1 extends BaseTest {
    ...
    @Test
    public void testSimpleOrderV1 () {
        Actions.mainActions().clearSession();
        Actions.mainActions().openPage(Constants.ORDER_URL);

        Actions.orderActions().performShowMeFreeTrialActivity();

        Pages.orderPage().waitLinkShowMeFreeTrialDisappear();
