...
public class OrderActions extends BaseActions {

    public OrderActions() {}

    public void performShowMeFreeTrialActivity() {
        Pages.orderPage().waitBody();
        Pages.orderPage().moveToPage();
        Pages.orderPage().moveToAddressLine();
        Pages.orderPage().clickLinkShowMeFreeTrial();
    }
